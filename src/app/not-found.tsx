			...
			<main className="flex-1 bg-gradient-to-br from-blue-50 via-white to-green-50">
				<div className="mx-auto px-4 py-20 container">
					<div className="mx-auto max-w-4xl text-center">
						...
						<div className="relative mb-12">
							<div className="flex justify-center items-center mx-auto mb-8 w-64 h-64">
								...
								<div className="relative">
									<div className="font-bold text-gray-200 text-8xl md:text-9xl select-none">
										404
									</div>
									...
									<div className="-right-8 bottom-12 absolute bg-purple-100 rounded-full w-14 h-14 animate-bounce delay-700">
										<div className="flex justify-center items-center w-full h-full">
										...
										>
											<Link href={link.href}>
												<CardContent className="p-6 text-center">
													<div
														className={`w-12 h-12 ${link.color} rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}
													>
						...
						{/* Search Suggestion */}
						<Card className="shadow-md mx-auto border-0 max-w-md">
